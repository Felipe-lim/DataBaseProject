...
from pags.users.create import display_create
from pags.users.read import display_read
from pags.users.update import display_update
from pags.users.delete import display_delete
